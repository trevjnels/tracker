1. If you add the JSON to your package.json and then type "npm install" in the project directory, you will get the two modules you need to run the tracker ('path' and 'fs')
